            ...
            <div class="col-lg-6 pull-right">
                ...
                <div class="row">
                    <div class="col-lg-10 col-lg-offset-2 pull-right">
                        ...
                        <hr>
                        @if(session('coupon'))
                        <h4>Popust(*{{ session()->get('coupon')['name'] }}) : -${{ number_format(session()->get('coupon')['discount'],2,'.',',') }}
            ...
            <div class="col-lg-6 pull-left">
                <div class="col-lg-12">
                    ...
                    <form action="{{ route('checkout.store') }}" id="payment-form" method="POST">
                        ...
                        <div class="form-group row">
                            <label for="example-tel-input" class="col-2 col-form-label">Drzava</label>
                            <div class="col-10">
                                <input class="form-control" type="text" id="province" name="province" placeholder="Drzava" value="@if(!Auth::guest())Srbija @endif">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <button type="button" class="btn btn-primary btn-block">PRIHVATAM</button>
